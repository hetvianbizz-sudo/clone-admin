    ...
    <Paper sx={{ maxWidth: 800, mx: 'auto', p: 2, boxShadow: 'none', border: borderStyle }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2, borderBottom: borderStyle, pb: 1 }}>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <Box sx={{ p: 2, mr: 2 }}>
            {po_data?.bill_to_logo !== "" ? (
              <img src={po_data?.bill_to_logo} alt="" className='' style={{height: "70px"}} />
            ) : (
              <div className='d-flex align-items-center justify-content-center' style={{ border: "2px solid gray", borderRadius: "10px", height: "80px", width: "80px" }}>
                <span style={{ fontSize: "40px", fontWeight: "700" }}>{po_data?.bill_to_name?.slice(0, 2)?.toUpperCase()}</span>
              </div>
            )}
          </Box>
          <Box>
            <h5 style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>{po_data.bill_to_name}</h5>
            <h5 style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>{po_data.bill_to_address}</h5>
            <h5 style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>{po_data.bill_to_city}, {po_data.bill_to_state} - {po_data.bill_to_pincode}</h5>
            <h5 style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>{po_data.bill_to_gst_in}</h5>
            <h5 style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>{buyerDetails?.[0]?.bill_to_phone}</h5>
          </Box>
        </Box>
      </Box>
      ...
      >
        ...
        <Grid container sx={{ p: 2 }}>
          ...
          <Grid item xs={12} sm={4} sx={{ borderRight: '1px solid #ddd', p: 1 }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 'bold', mb: 1 }}>Details of Buyer / Shipped To :</Typography>
          ...
          <Grid item xs={12} sm={4} sx={{ borderRight: '1px solid #ddd', p: 1 }}>
            ...
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              Name :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_name}</p>
            </h5>
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              GSTIN :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_gst_in}</p>
            </h5>
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              Address :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_address}</p>
            </h5>
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              Country :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_country}</p>
            </h5>
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              State :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_state}</p>
            </h5>
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              City :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_city}</p>
            </h5>
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              Pincode :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_pincode}</p>
            </h5>
            <h5 className="d-flex mb-2" style={{ fontSize: '16px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>
              Phone :
              <p className="ps-2" style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>{po_data.seller_to_phone}</p>
            </h5>
          </Grid>
      ...
      >
        ...
        >
          ...
          {po_data?.seller_to_state === po_data?.bill_to_state ? (
            <h5 style={{ fontSize: '14px', fontWeight: 'bold', color: '#044711', marginBottom: '0' }}>CGST/SGST</h5>
          ) : (
            <h5 style={{ fontSize: '14px', fontWeight: 'bold', color: '#044711', marginBottom: '0' }}>GST</h5>
          )}
      ...
      <Grid container sx={{ border: borderStyle, mt: 2 }}>
        <Grid item xs={6} sx={{ borderRight: borderStyle, p: 1 }}>
          <Box sx={{ borderBottom: borderStyle, pb: 1, mb: 1 }}>
            ...
            <Typography>{numberToWords(po_data?.grand_total)}</Typography>
          </Box>
          <Box>
        ...
        <Grid item xs={6} sx={{ p: 1 }}>
          ...
          {po_data?.seller_to_state !== po_data?.bill_to_state ? (
            ...
            <>
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                <h5 style={{ fontSize: '14px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>Add: SGST</h5>
                <p style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>
                  {(totals.totalGstAmount / 2).toFixed(2)}
                </p>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                <h5 style={{ fontSize: '14px', fontWeight: '600', color: '#044711', marginBottom: '0' }}>Add: CGST</h5>
                <p style={{ fontSize: '16px', fontWeight: '500', marginBottom: '0' }}>
                  {(totals.totalGstAmount / 2).toFixed(2)}
                </p>
              </Box>
