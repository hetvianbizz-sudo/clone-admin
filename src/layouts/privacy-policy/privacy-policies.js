...
//         if (!terms) {
//             setMessage("Please Enter Privacy Policy");
//             openErrorSB();
//             return;
//         }
...
//             }
//         } catch (error) {
//             setMessage("Error updating Privacy Policy.");
//             openErrorSB();
...
function PrivacyPolicies() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.put(
                `${BASE_URL}/api/privacy_policy/update?adminId=${localStorage.getItem("admin_id")}`,
                { values: terms },
                {
                    headers: {
                        "Content-Type": "application/json",
